function get_user_id(){
  ...
  function set_page(box){
    ...
    prev.setAttribute("class", "prev_code");
    prev.style.fontSize = '40px'
    prev.innerHTML = "&lt;";
    next.setAttribute("class", "next_code");
    next.innerHTML = "&gt;";
  ...
  slide_wrapper.setAttribute("class", "slide_wrapper_code");
  slides.setAttribute("class", "slides_code");
  
  box.style.width = "100%"
  box.style.height = "100%"
  box.style.margin = 'auto'
  box.setAttribute("class", "code_box");
  
  intellisys_box.setAttribute("class", "intellisys_code");
  ...
  var slides_ = document.querySelector('.slides_code'),
      slide = document.querySelectorAll('.slides_code li'),
      prevBtn = document.querySelector('.prev_code'),
      nextBtn = document.querySelector('.next_code'),
      currentIdx = 0,
      slideCount = slide.length,
      slideWidth = Math.ceil(slide_wrapper.offsetWidth/4 - document.querySelector('.prev_code').offsetWidth/(imglist.length*3) *2)
  ...
  function updateWidth(){
    var currentSlides = document.querySelectorAll('.slides_code li')
  ...
  function set_style() {
    ...
    *{margin:0; padding: 0;}\
    ...
    .intellisys_code{height: 200px; border: 1px solid black; margin: 0 auto;}\
    .slide_wrapper_code{position: relative; width: 100%; height: 80%; overflow: hidden; margin: 0 auto;}\
    .slides_code{position: absolute; left: 0; top: 0; padding-left: 0;}\
    .slides_code.animated{transition: 0.5s ease-out;}\
    .prev_code {margin: auto;}\
    .next_code {margin: auto;}\
    .slides_code li{width:"+slideWidth+"px; height: 100px; float: left;}"
  }
